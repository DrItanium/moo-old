...
extern long long CastAs16BitNumber(void* theEnv);
...
extern void BinaryOperationsFunctionDefinitions(void* theEnv) {
	...
	EnvDefineFunction2(theEnv, "cast-as-short", 'g', PTIEF CastAs16BitNumber, "CastAs16BitNumber", "11i");
}
...
long long CastAs16BitNumber(void* theEnv) {
	DATA_OBJECT arg0;
	if(EnvArgTypeCheck(theEnv, "cast-as-short", 1, INTEGER, &arg0) == FALSE) { 
		return 0LL;
	}
	return (long long)(short)DOToLong(arg0);
}
